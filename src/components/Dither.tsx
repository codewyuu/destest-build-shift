...
const RetroEffect = forwardRef<RetroEffectImpl, { colorNum: number; pixelSize: number }>(({ colorNum, pixelSize }, ref) => {
...
function DitheredWaves({
  ...
  const [uniformsToPass, setUniformsToPass] = useState<WaveUniforms | null>(null);
